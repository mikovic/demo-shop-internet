package com.mikovic.demoshopinternet.repositories.specifications;
...
//    public static Specification<Product> subcategoryIdEq(Long subcategoryId) {
//        return (Specification<Product>) (root, criteriaQuery, criteriaBuilder) -> {
//            return criteriaBuilder.equal(root.get("subcategory"), subcategoryId);
//        };
//    }
}
